...
import (
	...
	versioned "github.com/heheh13/crd/pkg/client/clientset/versioned"
	internalinterfaces "github.com/heheh13/crd/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/heheh13/crd/pkg/client/listers/example.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ExampleV1().Databases(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ExampleV1().Databases(namespace).Watch(context.TODO(), options)
			},
		},
